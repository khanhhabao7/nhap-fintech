...
SCENARIOS = [
    ...
    {"id": 5, "name": "Customer Spending Slows and Market Demand for New Products Weakens ", "cat": "Market", "tags": ["demand", "price", "marketing_eff"], "delta": {"price": -0.05, "marketing_eff": -0.12, "hype": -10, "utility": -3, "runway": -1}},
    ...
    {"id": 8, "name": "Product Complaints Increase and Customer Trust Drops", "cat": "Internal", "tags": ["product", "reputation"], "delta": {"utility": -12, "hype": -10, "transparency": -8, "trust_all": -12, "runway": -1}},
...
ACTIVE_CARDS_FULL = [
    {"id": "A1", "name": "Low-Budget Target Ads", "cost": 1, "type": "red", "desc": "Run a small paid ad test to increase demand and visibility.", "counters": ["demand", "marketing_eff", "visibility"], "effect": {"hype": 6, "visibility": 5, "cost_percent": 1}},
 	...
 	{"id": "A3", "name": "Customer Referral Loop", "cost": 1, "type": "red", "desc": "Turn existing users into a small organic growth loop.", "counters": ["demand", "product_opportunity"], "effect": {"hype": 6, "trust_all": 3, "utility": 2}},
    ...
    {"id": "A5", "name": "Press Outreach Cycle", "cost": 2, "type": "red", "desc": "Pitch the startup story to gain public  attention.", "counters": ["visibility", "reputation", "market_opportunity"], "effect": {"hype": 12, "visibility": 14, "trust_all": 3, "cost_percent": 2}},
 	...
 	{"id": "A10", "name": "Customer Proof Campaign", "cost": 2, "type": "red", "desc": "Use customer success stories to convert credibility into demand.", "counters": ["reputation", "demand"], "effect": {"trust_all": 7, "utility": 4, "hype": 7, "transparency": 3, "cost_percent": 2}},
    {"id": "A11", "name": "Full-Scale Brand Repositioning", "cost": 3, "type": "red", "desc": "Launch a large brand campaign to change market perception and defend against competitors.", "counters": ["competition", "demand", "market_opportunity", "reputation"], "effect": {"hype": 22, "visibility": 22, "trust_all": 5, "cost_percent": 6}},
 	{"id": "A12", "name": "National Launch Rollout", "cost": 3, "type": "red", "desc": "Run a broad launch rollout to create national awareness and accelerate acquisition.", "counters": ["demand", "visibility", "product_opportunity", "market_opportunity"], "effect": {"hype": 24, "visibility": 24, "utility": 6, "cost_percent": 7, "runway": -1}},
