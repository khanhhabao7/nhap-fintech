...
SCENARIOS = [
    {"id": 1, "name": "Market Liquidity Improves and Capital Becomes Easier to Raise", "cat": "Market", "tags": ["market_opportunity", "capital_availability"], "delta": {"price": 0.04, "hype": 10}},
    ...
    {"id": 12, "name": "Unit Economics Improve and the Business Model Looks More Sustainable", "cat": "Internal", "tags": ["cost_opportunity", "funding_readiness", "investor_confidence"], "delta": {"cogs": -0.04, "hype": 8, "trust_all": 8, "runway": 1}},
    {"id": 13, "name": "Competitor Cuts Prices and Puts Pressure on Customer Demand", "cat": "External", "tags": ["competition", "price", "demand"], "delta": {"price": -0.05, "marketing_eff": -0.10, "hype": -6}},
    {"id": 14, "name": "Competitor Launches a Better Product and Weakens Your Market Position", "cat": "External", "tags": ["competition", "product", "reputation"], "delta": {"price": -0.08, "marketing_eff": -0.18, "hype": -15, "trust_all": -5}},
    {"id": 15, "name": "Strategic Partnership Opportunity Appears and Opens a New Growth Channel", "cat": "External", "tags": ["partnership", "market_opportunity", "funding_readiness", "investor_confidence"], "delta": {"price": 0.04, "marketing_eff": 0.12, "hype": 12, "trust_all": 5}},
    ...
    {"id": 18, "name": "Platform Algorithm Reduces Campaign Reach and Marketing Efficiency Drops", "cat": "External", "tags": ["marketing_eff", "visibility", "demand"], "delta": {"marketing_eff": -0.20, "visibility": -15, "hype": -10}},
...
ACTIVE_CARDS_FULL = [
    ...
    {"id": "A5", "name": "Press Outreach Cycle", "cost": 2, "type": "red", "desc": "Pitch the startup story to gain public  attention.", "counters": ["visibility", "reputation", "market_opportunity"], "effect": {"hype": 12, "visibility": 14, "trust_all": 3, "cost_percent": 2}},
 	...
 	{"id": "A7", "name": "Conversion Funnel Refresh", "cost": 2, "type": "red", "desc": "Improve landing pages, messaging, and conversion flow to recover weak demand.", "counters": ["marketing_eff", "demand", "price"], "effect": {"hype": 8, "utility": 3, "cost_percent": 3}},
    ...
    {"id": "C10", "name": "Strategic Channel Partnership", "cost": 2, "type": "purple", "desc": "Build a partnership that improves distribution, revenue visibility, and investor confidence.", "counters": ["partnership", "competition", "market_opportunity", "capital_availability"], "effect": {"trust_all": 10, "utility": 6, "funding_boost_percent": 4, "cost_percent": 3}},
    ...
    {"id": "C14", "name": "Strategic Investment Partnership", "cost": 3, "type": "purple", "desc": "Prepare a strategic acquisition, merger, or major investment negotiation to solve funding and competitive pressure.", "counters": ["competition", "partnership", "funding", "capital_availability"], "effect": {"funding_boost_percent": 20, "trust_all": 15, "dilution": 9, "cost_percent": 5}},
]
...
REACTION_CARDS = [
    ...
    {"id": "R7", "name": "Product Quality Recall", "trigger": "on_utility_low", "condition": {"metric": "utility", "operator": "<", "value": 35}, "desc": "Recall or fix poor-quality products before customer trust is damaged further.", "cost_percent": 5, "effect": {"trust_all": 8, "transparency": 5, "hype": -3}},
